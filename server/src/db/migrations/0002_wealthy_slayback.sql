...
ALTER TABLE "users" ALTER COLUMN "tg_id" SET DATA TYPE bigint;--> statement-breakpoint
ALTER TABLE "refresh_tokens" ADD COLUMN "consumed_at" text;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "battle_state" text DEFAULT '{}';--> statement-breakpoint
